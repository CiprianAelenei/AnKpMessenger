...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Referinta Profile Image in Storage
        ...
        if(imageUri != null){
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        Uri downlodadUri = task.getResult();
                        String mUri = downlodadUri.toString();
                        ...
                        Toast.makeText(getContext(), "Incarcarea a esuat!", Toast.LENGTH_SHORT).show();
                    }
            ...
            Toast.makeText(getContext(), "Nici o imagine selectata", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == IMAGE_REQUEST && requestCode == RESULT_OK && data != null && data.getData() != null){
            ...
            if(uploadTask != null && uploadTask.isInProgress()){
                ...
                Toast.makeText(getContext(), "Incarcare in curs...", Toast.LENGTH_SHORT).show();
